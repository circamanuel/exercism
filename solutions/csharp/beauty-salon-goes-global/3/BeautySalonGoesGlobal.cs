...
public static class Appointment
{
    ...
    public static bool HasDaylightSavingChanged(DateTime dt, Location location)
    {
        ...
        bool isNowDaylightSaving = timeZone.IsDaylightSavingTime(dt);
        bool isLastWeekDaylightSaving = timeZone.IsDaylightSavingTime(dt.AddDays(-7));

        return isLastWeekDaylightSaving != isNowDaylightSaving;
    }
